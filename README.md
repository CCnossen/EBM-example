This repo contains an operational example of a python code leveraging data from the Binance and Yahoo finance API endpoints to run an Explainable Boosting Machine model. 
